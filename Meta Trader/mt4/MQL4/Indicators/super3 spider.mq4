...
extern string IndicatorName = "SPIDER INDICADOR TELEGRAM @INDICADORESGRATIS (5)"; // Indicator File Name
extern int IndiBufferCall = 1;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut = 3;       // Signal Buffer Down ("Put") 

extern string s1 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName2 = "Bob03";
