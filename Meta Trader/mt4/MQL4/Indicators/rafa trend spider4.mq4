...
extern string IndicatorName = "RKNBLG"; // Indicator File Name
extern int IndiBufferCall = 3;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut = 2;       // Signal Buffer Down ("Put") 

extern string s1 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName2 = "DOT-ITM-RACHAM";
extern int IndiBufferCall2 = 5;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut2 = 4;       // Signal Buffer Down ("Put") 
...
extern string IndicatorName4 = "SPIDER INDICADOR TELEGRAM @INDICADORESGRATIS (5)";
extern int IndiBufferCall4 = 1;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut4 = 3;       // Signal Buffer Down ("Put") 
...
int start(){
   ...
   for(i=limit;i>=0;i--){
      ...
      // if signal DOWN (PUT)
      if (signal(dn) && signal(dn2)&& signal(dn3)&& signal(dn4)) {
