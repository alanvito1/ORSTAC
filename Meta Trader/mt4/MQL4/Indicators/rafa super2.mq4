...
extern string IndicatorName = "DiamanteIA Pro  TELEGRAM@INDICADORESGRATIS"; // Indicator File Name
...
extern string IndicatorName2 = "!!Color Stochastic";
extern int IndiBufferCall2 = 3;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut2 = 2;       // Signal Buffer Down ("Put") 
