...
extern string IndicatorName = "Bob05"; // Indicator File Name
...
extern string IndicatorName2 = "SPIDER INDICADOR TELEGRAM @INDICADORESGRATIS (5)";
extern int IndiBufferCall2 = 1;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut2 = 3;       // Signal Buffer Down ("Put") 

 
extern string s2 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName3 = "Price Pro Canal DonChian";
