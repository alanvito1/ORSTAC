...
extern string IndicatorName6 = "hull - moving average bands arrows";
extern int IndiBufferCall6 = 3;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut6 = 4;       // Signal Buffer Down ("Put") 


extern string s6 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName7 = "hull - moving average bands arrows";
extern int IndiBufferCall7 = 3;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut7 = 4;       // Signal Buffer Down ("Put") 


extern string s7 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName8 = "hull - moving average bands arrows";
extern int IndiBufferCall8 = 3;      // Signal Buffer Up ("Call") 
