...
extern string s8 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName9 = "stochastic-signals";
extern int IndiBufferCall9 = 5;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut9 = 4;       // Signal Buffer Down ("Put") 

extern string s9 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName10 = "stochastic-signals";
extern int IndiBufferCall10 = 5;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut10 = 4;       // Signal Buffer Down ("Put") 

extern string s10 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName11 = "stochastic-signals";
extern int IndiBufferCall11 = 5;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut11 = 4;       // Signal Buffer Down ("Put") 

extern string s11 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName12 = "stochastic-signals";
extern int IndiBufferCall12 = 5;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut12 = 4;       // Signal Buffer Down ("Put") 
...
int start(){
   ...
   for(i=limit;i>=0;i--){
      if (IndicatorName != "" && IndicatorName2 != "" && !alerted) {
         ...
         up9 = iCustom(NULL, 0, IndicatorName9, IndiBufferCall9, i);
         dn9 = iCustom(NULL, 0, IndicatorName9, IndiBufferPut9, i);
         if (GetLastError() == 4072){ Alert("Error: '" + IndicatorName9+"' indicator is not found!");alerted=true; }    
         up10 = iCustom(NULL, 0, IndicatorName10, IndiBufferCall10, i);
         dn10 = iCustom(NULL, 0, IndicatorName10, IndiBufferPut10, i);
         if (GetLastError() == 4072){ Alert("Error: '" + IndicatorName10+"' indicator is not found!");alerted=true; }             
         up11 = iCustom(NULL, 0, IndicatorName11, IndiBufferCall11, i);
         dn11 = iCustom(NULL, 0, IndicatorName11, IndiBufferPut11, i);
         if (GetLastError() == 4072){ Alert("Error: '" + IndicatorName11+"' indicator is not found!");alerted=true; }             
         up12 = iCustom(NULL, 0, IndicatorName12, IndiBufferCall12, i);
         dn12 = iCustom(NULL, 0, IndicatorName12, IndiBufferPut12, i);
         if (GetLastError() == 4072){ Alert("Error: '" + IndicatorName12+"' indicator is not found!");alerted=true; }             
      ...
      double gap = 0.02;
      // if signal UP (CALL)
      if (signal(up) && signal(up2)&& signal(up3)&& signal(up4)&& signal(up5)&& signal(up6)&& signal(up7)&& signal(up8)&& signal(up9)&& signal(up10)&& signal(up11)&& signal(up12)) {
      ...
      // if signal DOWN (PUT)
      if (signal(dn) && signal(dn2)&& signal(dn3)&& signal(dn4)&& signal(dn5)&& signal(dn6)&& signal(dn7)&& signal(dn8)&& signal(dn9)&& signal(dn10)&& signal(dn11)&& signal(dn12)) {
