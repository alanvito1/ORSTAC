...
extern string IndicatorName = "Jackmate - Pullback"; // Indicator File Name
extern int IndiBufferCall = 2;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut = 0;       // Signal Buffer Down ("Put") 

extern string s1 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName2 = "cci obos arrows";
