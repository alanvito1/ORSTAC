...
extern string IndicatorName = "2Trend"; // Indicator File Name
...
extern string IndicatorName2 = "Jackmate - Pullback";
extern int IndiBufferCall2 = 2;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut2 = 0;       // Signal Buffer Down ("Put") 

 
extern string s2 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName3 = "RKNBLG";
extern int IndiBufferCall3 = 3;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut3 = 2;       // Signal Buffer Down ("Put") 
