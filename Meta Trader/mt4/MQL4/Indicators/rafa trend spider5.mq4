...
extern string IndicatorName = "DOT-ITM-RACHAM"; // Indicator File Name
extern int IndiBufferCall = 5;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut = 4;       // Signal Buffer Down ("Put") 
...
extern string IndicatorName3 = "SPIDER INDICADOR TELEGRAM @INDICADORESGRATIS (5)";
extern int IndiBufferCall3 = 1;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut3 = 3;       // Signal Buffer Down ("Put") 

extern string s3 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName4 = "Price Pro Value Chart Premium 5-8 Mantem Pre Alerta";
extern int IndiBufferCall4 = 0;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut4 = 1;       // Signal Buffer Down ("Put") 

extern string s4 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName5 = "RKNBLG";
extern int IndiBufferCall5 = 3;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut5 = 2;       // Signal Buffer Down ("Put") 
...
int start(){
   ...
   for(i=limit;i>=0;i--){
      ...
      double gap = 0.02;
      // if signal UP (CALL)
      if (signal(up) && signal(up2)&& signal(up3)&& signal(up4)&& signal(up5)) {
      ...
      // if signal DOWN (PUT)
      if (signal(dn) && signal(dn2)&& signal(dn3)&& signal(dn4)&& signal(dn5)) {
