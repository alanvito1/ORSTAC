...
extern string IndicatorName2 = "Thor Rs1";
extern int IndiBufferCall2 = 4;      // Signal Buffer Up ("Call") 
extern int IndiBufferPut2 = 5;       // Signal Buffer Down ("Put") 

 
extern string s2 = "===== SIGNAL SETTINGS ============="; // ======================
extern string IndicatorName3 = "Guns Catalogador";
...
{     
   ...
   ChartSetInteger(0,CHART_COLOR_CHART_DOWN,clrViolet);
